                            ...
                            <div class="card-body">
                                ...
                                <form action="./dashboard.php" method="post">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-9">
                                            <select name="currparcour" class="form-select"
                                                aria-label="Default select example" required>
                                                <option selected hidden disabled value="">Parcours</option>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-grid gap-2 mt-3">
                                                <a href="./addPlayer.php" type="button"
                                                    class="btn btn btn-success <?=count($_SESSION['players']) >= 10 ? 'disabled' : '' ?>">Add
                                                    Player</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div>
                                            <select name="countSys" class="form-select"
                                                aria-label="Default select example" required>
                                                <option selected hidden disabled value="">Modes</option>
