...
START TRANSACTION;
USE `arcusdb`;
INSERT INTO `arcusdb`.`user` (`userId`, `firstName`, `lastName`, `nickName`, `password`, `guest`) VALUES (DEFAULT, 'Max', 'Mustermann', 'musterm', '12345', 0);
INSERT INTO `arcusdb`.`user` (`userId`, `firstName`, `lastName`, `nickName`, `password`, `guest`) VALUES (DEFAULT, 'Maria', 'Musterfrau', 'mustername', '12345', 0);
INSERT INTO `arcusdb`.`user` (`userId`, `firstName`, `lastName`, `nickName`, `password`, `guest`) VALUES (DEFAULT, 'Markus', 'Musterer', 'mustermuster', '12345', 0);
